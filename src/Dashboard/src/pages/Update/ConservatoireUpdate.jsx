...
const Updateconservatoire = ({ title }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setconservatoire(userData.adressconservatoire);

            } catch (error) {
                console.error("Erreur lors de la récupération des Conservatoire :", error);
            }
        };
    ...
    const updateconservatoire = async (e) => {
        e.preventDefault();
        try {
            ...
            const res = await axios.put(`http://localhost:8000/api/v1/conservatoire/${_id}`, formData, {
                headers: {
            ...
            console.log(error);
            alert("Erreur lors de la modification de l'Conservatoire. Veuillez réessayer.");
        }
    };
                            ...
                            <form encType="multipart/form-data">
                                ...
                                <div className="formInput">
                                    ...
                                    <input
                                        ...
                                        id="conservatoire"
                                        name="conservatoire"
                                        placeholder="Enter conservatoire Adress"
                                        value={conservatoire}
                                        onChange={handleConservatoireChange}
                                    />
                                </div>
                                <button onClick={updateconservatoire}>Enregistrer</button>
                            </form>
                        </div>
                    </div>
                )}
...
export default Updateconservatoire;
